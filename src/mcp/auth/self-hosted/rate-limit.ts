...
export interface RateLimiter { check(bucket: string, identity: string, limit: number): Promise<void>; }
export class RateLimitError extends Error {}
export class PostgresRateLimiter implements RateLimiter {
  constructor(private db: PrismaClient, private credentials: Credentials) {}
